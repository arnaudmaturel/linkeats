            ...
            <div id="img">
                <div id="infPart">
                    ...
                    <v-row>
                        <v-col class="ma-auto">
                            <h6>Code postal</h6>
                            <v-text-field v-model="data.cp" :readonly="loading" clearable placeholder="Saisissez le code postal"
                ...
                <v-row>
                    <v-col class="ma-auto">
                        <h6>Ville</h6>
                        <v-text-field v-model="data.city" :readonly="loading" clearable
                        placeholder="Saisissez la ville souhaité" :rules="[required]" class="mb-2"
