...
function clientModel(sequelize) {
	const attributes = {
		...
		RestaurantImgIdentityPath: { type: DataTypes.STRING, allowNull: false, defaultValue: "" },
		RestaurantImgBannerPath: { type: DataTypes.STRING, allowNull: false, defaultValue: "" },
		...
		UserRole: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 2 },
